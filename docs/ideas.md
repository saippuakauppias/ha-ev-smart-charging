...
- Батарейка в датчике садится за месяцы, и отказ будет тихим. Нужен
  собственный контроль свежести, иначе появится новый источник тихих сюрпризов.
...
Куда дороже обходились недодача тока (около 40 минут за сессию) и потерянные
...
пересчёте: за долгую сессию это до полутора десятков одинаковых сообщений. Такие
...
и лишь в те сессии, когда обрыв пришёлся на последние минуты. Отдельно стоит
